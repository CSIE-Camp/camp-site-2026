...
const days = [
    ...
    },
    {
        title: '07.07 (二)',
        sessions: [
            { time: '09:50–11:50', tag: '早上', tagClass: 'tag-morning', title: '選修課一', desc:'電腦硬體選購與裝修<br>AI 的偏見可能比你想的嚴重<br>n8n實踐與原理',detail: '【通識課程｜ 一次了解電腦規格在寫什麼 —— 電腦硬體選購與裝修 】<br>你每天都在用電腦，但你有沒有想過，那個看起來安安靜靜的主機殼裡，到底裝了些什麼？<br>CPU、顯示卡、記憶體、硬碟……這些名詞你可能聽過，但它們各自是做什麼的？<br>買電腦時規格表上那些「核心數、頻率、容量」又到底代表什麼？<br>如果哪天電腦有點小問題，你有沒有可能自己先看懂、甚至動手處理？<br><br>【通識課程｜ AI 的偏見可能比你想的嚴重 —— 從底層原理了解 AI 的社會爭議】<br>近期崛起的大型語言模型（LLM）近乎無所不能，他可以回答問題、會整理資料、也能生成圖片，看起來就好像什麼都知道、什麼都會做。<br>但，它一定是對的嗎？<br>科技的發展，可能造成什麼社會問題？<br>該怎麼權衡我們的抉擇，在瞬息萬變的社會中保有自己的中心思想？<br>如何從原理看待 AI，進而與 AI 有更好的互動？<br><br>【通識課程｜ 沒有程式背景也能輕鬆駕馭的流程自動化工具 —— n8n 的實踐與原理】<br>你平常會不會也這樣用 AI？像是問問題、請它整理重點、幫忙想文案，好像很方便，但每次都還是得自己一個指令一個指令地下。<br>那如果今天，你不是只有「跟 AI 聊天」，而是可以讓 AI 自己幫你完成一連串任務呢？<br>你不需要會寫很多程式，只要具備一個 Google 帳號，搭配n8n自動化工具，就有機會在這堂課中，把原本只會聊天的 AI，升級成真正能幫你做事的「守護神」！' },
            { time: '', tag: '', tagClass: '', title: '午餐時間', desc: '', detail: '' },
             { time: '13:10–16:10', tag: '下午', tagClass: 'tag-afternoon', title: '主題課程二', desc: '讓網頁動起來 ——<br>用 JavaScript 開發互動式小應用', detail: '還記得 2021 風靡世界的 pop cat 嗎，<br>雖然我們會架網站了，但要怎麼樣才能讓自己的網頁動起來呢？<br>在這堂課程中，將透過實際操作程式語言，讓你的網頁動起來！<br><br>📌 課程內容1. 程式語言基礎 —— JavaScript 基礎語法（變數、條件判斷、迴圈等...）<br>2. 親手感受程式語言 —— 透過小任務實際運用上述語法<br>3. 讓網頁動起來 —— JavaScript DOM 介紹與使用<br><br>🥸☝️ 這堂課中我們將學到<br>1. JavaScript 程式語言的語法<br>2. 如何打造可互動的網頁<br>3. 製作自己的 Bongo Cat！<br><br>在這個科技更迭的時代，學會一個程式語言絕對不吃虧！<br>趕快來跟我們一起探索前端的世界吧！' },
    ...
    },
    {
        ...
        sessions: [
            ...
            { time: '', tag: '', tagClass: '', title: '午餐時間', desc: '', detail: '' },
            { time: '13:10–15:10', tag: '下午', tagClass: 'tag-afternoon', title: '選修課二', desc: '網路安全基礎<br> Python 的基礎與應用<br>從電腦的視角來理解 Minecraft 的大小事', detail: '【通識課程｜ 揭開網路駭客的面紗 —— 網路安全基礎 】<br>一個看起來很普通的登入頁面，為什麼可能因為一行輸入，就被直接繞過驗證？<br>一個網站上的小小欄位，又怎麼可能變成攻擊整個系統的入口？<br>想知道網站漏洞到底是怎麼一層一層被拆解的？<br>也想親自挑戰看看，能不能在 CTF 中找出關鍵破綻嗎？<br><br>【通識課程 ｜ 一堂課掌握市佔率最高的程式語言 —— Python 的基礎與應用】<br>你是不是覺得，學程式好像很困難、要讀很多英文、概念又很抽象？<br>如果今天有圖像化的程式，結合現實生活的範例，會不會比較沒那麼可怕?<br>此時如果再給你一個工具，他可以陪你一起理解程式、幫你整理想法，<br>甚至在你卡住的時候給你提示，那完成一個程式專案，是不是就沒有那麼遙遠了？<br><br>【通識課程 ｜ 你所不知的另一面 —— 從電腦的視角來理解 Minecraft 的大小事】<br>正在載入世界...<br>叮，歡迎來到 Minecraft 的世界。<br>欸？電腦又沒有眼睛，看不到地形與風景，要怎麼模仿真實的世界？<br>電腦有沒有極限，有哪些情況會看到崩壞的世界？今天，就用一堂課時間，帶大家透過電腦的眼睛，看看 Minecraft 到底長怎樣！<br>「本課程非 MINECRAFT 官方產品。未經 MOJANG 或 MICROSOFT 核准，亦與其無關。」' },
